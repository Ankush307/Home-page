...
const DanceParty = () => {
    ...
    return (
        <div className='bg-black min-h-screen flex items-center justify-center flex-col'>
            <button onClick={toggleDance} className={`absolute top-10 bg-white py-2 px-6 rounded-lg font-bold text-lg shadow-lg transform transition-all duration-300 ease-in-out ${isActive ? '!bg-slate-600 text-white' : ''} `}>Change Dance Pose </button>
            <h1 className="text-white font-extrabold md:text-6xl sm:text-5xl text-4xl mb-12"> DANCE PARTY!</h1>
            <div className="w-full flex items-center justify-center flex-col">
                ...
                {/* Arms */}
                <div className="flex gap-20 sm:w-[500px] w-full items-center justify-center translate-y-[-100px] relative z-10">
