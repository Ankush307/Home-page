...
const Services = () => {
    ...
    return (
        <div className="lg:pt-[100px] lg:pb-[181px] sm:pt-20 sm:pb-[62px] pt-[34px] pb-[30px] max-w-[1920px] mx-auto relative min-h-screen flex items-center justify-center">
            <div className="container mx-auto max-w-[1140px]">
                <div className="max-xl:px-[30px] max-sm:px-4">
                    <p className="sm:text-tiny-5xl text-[32px] leading-121 sm:pt-6 pt-[13px] md:pb-10 pb-6 font-bold max-lg:max-w-[465px] max-sm:max-w-[287px] text-dark-black">Dynamic Image Carousel with Swiper</p>
                </div>
                        ...
                        {SERVICES_LIST.map((item, index) => (
                            <SwiperSlide key={index} className="w-[209px]">
                                <div className="relative cursor-pointer overflow-hidden w-[209px]" onClick={() => setActiveIndex(index)}>
                                    ...
                                    <img className="h-[300px] w-[209px]" src={item.cardImg} alt="services img" />
                                </div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
